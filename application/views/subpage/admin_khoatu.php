...
<div class="row">
		<div class="col-xs-12">
			<h3 class="header smaller lighter blue">Danh sách Các Khóa Tu <a class="btn btn-primary"   href='<?php echo base_url() ?>admin/khoatumoi'>Thêm mới</a></h3>
						...
						foreach ($data as $key => $value) {
							...
							<td>
								<div class="hidden-sm hidden-xs action-buttons">
									...
									<a class="green" href="<?php echo base_url() ?>admin/khoatuchitiet/<?php echo $value->idtintuc ?>"  >
