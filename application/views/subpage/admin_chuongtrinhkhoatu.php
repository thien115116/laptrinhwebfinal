...
<div class="row">
		<div class="col-xs-12">
			<h3 class="header smaller lighter blue">Danh sách Các chương trình Khóa Tu <a class="btn btn-primary"   href='<?php echo base_url() ?>admin/chuongtrinhkhoatumoi'>Thêm mới</a></h3>
				...
				<table id="dynamic-table-daotrang" class="table table-striped table-bordered table-hover">
					<thead>
						<tr>
							...
							<th>thông tin</th>
							<th>ngày tu</th>
							<th>Ngày bắt đầu ĐK</th>
							<th>Ngày kết thúc ĐK</th>
							<th>
							Số lượng ĐK</th>
							<th>#</th>
						</tr>
					...
					<tbody>
						...
						foreach ($data as $key => $value) {
							...
							<td>
								<a href="#"><?php echo $value->idctkhoatu ?></a>
							</td>
							<td><?php echo $value->tieude ?></td>
							<td class="hidden-480"><?php echo $value->tomtat ?></td>
							
							<td>
								<?php echo $value->ngaybatdautu ?><br> - <?php echo $value->ngayketthuctu ?>
							</td>
							<td>
							...
							<td>
								<a href="<?php echo base_url() ?>admin/ketquadangky/<?php echo $value->idctkhoatu ?>"><?php echo $value->soluongdangky; ?></a>
							</td>
							<td>
								<div class="hidden-sm hidden-xs action-buttons">
									<a class="blue" href="<?php echo base_url() ?>admin/dangky/<?php echo $value->idctkhoatu ?>" title="Đăng ký cho thành viên trong khóa tu này">
										<i class="ace-icon fa fa-search-plus bigger-130"></i>
									</a>

									<a class="green" href="<?php echo base_url() ?>admin/chuongtrinhkhoatuchitiet/<?php echo $value->idctkhoatu ?>"  title="Chỉnh sửa nội dung chương trình khóa tu">
										<i class="ace-icon fa fa-pencil bigger-130"></i>
									</a>

									<a class="red" href="#" 
									onClick="ChuongTrinhKhoaTuXoa('<?php echo $value->idctkhoatu ?>'); return false;" title="Xóa chương trình khóa tu chưa đăng ký">
...
<div class="modal fade" id="ModalKhoaTuThem" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"  aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    ...
    <div class="modal-content">
      ...
      <button class="btn btn-deep-orange" onclick="KhoaTuLuuMoi()">Thêm mới</button>
      </div>
    </div>
...
{
	alert('New');
	url = base_url +'admin/KhoaTuluumoi/';
...
function ChuongTrinhKhoaTuXoa(id)
{
	if (!confirm('ban chac chan muon xoa?')) return;
	url = base_url+ 'admin/ChuongTrinhKhoaTuXoa/'+id;
