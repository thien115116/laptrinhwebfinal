<div class="row">
		<div class="col-xs-12">
			<h3 class="header smaller lighter blue">Danh sách thành viên đã đăng ký Khóa Tu: 
			<?php
			if (isset($ctkhoatuchitiet))
			{
				echo $ctkhoatuchitiet->tieude;
				echo " ({$ctkhoatuchitiet->ngaybatdautu} , {$ctkhoatuchitiet->ngayketthuctu} )";
			}
			?>
			</h3>
			...
			<div class="row">
				...
				<li style="display: inline-block;width: 20%; border-style: groove; margin-left: 3px">
							...
							<table class="table table-hover">
								<tr>
									...
									<td>
										<a href="<?php echo base_url()?>admin/ketquadangky/<?php echo $idctkhoatu ?>">
										Tất cả đăng ký </a>
									</td>
								</tr>
							</table>
				...
				<?php
				//echo $daotrangdangchon;
				if (!isset($daotrangdangchon)) $daotrangdangchon='';
				foreach($daotrang as $v)
					{
						if ($daotrangdangchon==$v->iddaotrang )
							$c=' background:#E6CFCF; ';
						else $c='';
						?>
						<li style="<?php echo $c;?>display: inline-block;width: 20%; border-style: groove; margin-left: 3px">
							<a href="<?php echo base_url()?>admin/user/<?php echo $v->iddaotrang ?>?iddaotrang=<?php $v->iddaotrang ?>">
								<?php echo $v->tendaotrang ?>
							</a>
							<table class="table table-hover">
								<tr>
									<td>
										<a href="<?php echo base_url()?>admin/user/<?php echo $v->iddaotrang ?>">Danh sách thành viên </a>
									</td>
									<td>
										<a href="<?php echo base_url()?>admin/ketquadangky/<?php echo $idctkhoatu ?>?iddaotrang=<?php echo $v->iddaotrang ?>">
										DS đăng ký </a>
									</td>
								</tr>
							</table>
			...
			<div>
				<table id="dynamic-table" class="table table-striped table-bordered table-hover">
					<thead>
						<?php
							$this->load->view('subpage/admin_list_ketquadangky_thead.php');
						?>
					</thead>
					<tbody>
						<?php
						foreach ($data as $key => $value) {
							...
							<td ><?php echo substr($value->ngaythaotac, 0, 19) ?></th>
							<td ><?php echo $value->ghichu ?></th>
							<td ><?php echo $value->tendaotrang ?></th>							
							<td>
