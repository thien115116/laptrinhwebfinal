...
<div class="row">
		...
		<div class="col-xs-12">
			<h3 class="header smaller lighter blue">Danh sách Gallery <a class="btn btn-primary"  data-toggle="modal" href='#ModalSliderThem'>Thêm mới</a></h3>
				...
				<table id="dynamic-table-daotrang" class="table table-striped table-bordered table-hover">
					...
					<tbody>
						...
						foreach ($data as $key => $value) {
							...
							<td>
								<a href="#"><?php echo $value->idgallery ?></a>
							</td>
							<td class="hidden-480"><?php echo $value->ten ?></td>
							<td>
								<img width="200" src="<?php echo base_url()?>assets/image/gallery/<?php echo $value->hinhdaidien ?>">
								</td>
							...
							<td>
								<div class="hidden-sm hidden-xs action-buttons">
									<a class="blue"  title="Thêm hình cho album" href="<?php echo base_url() .'admin/gallerychitiet/'. $value->idgallery ?>">
										<i class="ace-icon fa fa-search-plus bigger-130"></i>
									</a>

									<a class="green" href="#"   data-toggle="modal"  data-target="#ModalAlbumSua" data-id="<?php echo $value->idgallery ?>">
										<i class="ace-icon fa fa-pencil bigger-130"></i>
									</a>

									<a class="red" href="#" 
									onClick="SliderXoa('<?php echo $value->idgallery ?>'); return false;">
