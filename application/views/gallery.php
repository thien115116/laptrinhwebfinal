...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url() ?>assets/simpleLightbox.css">
                ...
                <div class="row imageGallery1" id="gallery">
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="<?php echo base_url()?>assets/image/gallery/01.jpg" alt="">
                            <div class="hover">
                    ...
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="<?php echo base_url()?>assets/image/gallery/02.jpg" alt="">
                            <div class="hover">
                    ...
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="<?php echo base_url()?>assets/image/gallery/03.jpg" alt="">
                            <div class="hover">
                    ...
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="<?php echo base_url()?>assets/image/gallery/04.jpg" alt="">
                            <div class="hover">
                    ...
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="<?php echo base_url()?>assets/image/gallery/06.jpg" alt="">
                            <div class="hover">
                    ...
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="<?php echo base_url()?>assets/image/gallery/05.jpg" alt="">
                            <div class="hover">
                    ...
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="<?php echo base_url()?>assets/image/gallery/01-1.jpg" alt="">
                            <div class="hover">
                    ...
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="<?php echo base_url()?>assets/image/gallery/02-1.jpg" alt="">
                            <div class="hover">
                    ...
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="<?php echo base_url()?>assets/image/gallery/03-1.jpg" alt="">
                            <div class="hover">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
        ...
        <script src="js/stellar.js"></script>
        <script src="<?php echo base_url() ?>/assets/js/simpleLightbox.min.js"></script>
        <script src="<?php echo base_url() ?>/assets/js/owl.carousel.min"></script>
