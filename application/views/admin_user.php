...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Tables - Quản trị website</title>
					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="<?php echo base_url()?>assets/admin/assets/images/avatars/user.jpg" alt="<?php
									$admin_login = $this->session->userdata('admin_login');
									if ($admin_login)
										echo $admin_login->last_name.' '. $admin_login->first_name;
									?>'s Photo" />
