					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="<?php echo base_url();?>assets/images/avatars/user.jpg" alt="<?php
							...
							<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								...
								<li>
									<a href="<?php echo base_url() ?>user_authentication/logout">
				...
				<ul class="nav nav-list">
					...
					<li class="active open">
						<a href="#" class="dropdown-toggle">
							...
							<span class="menu-text"> Văn phòng MBS</span>
							<b class="arrow fa fa-angle-down"></b>
						</a>
						...
						<ul class="submenu">
							<li class="active">
								<a href="<?php echo base_url() ?>quanly/dsnv">
									<i class="menu-icon fa fa-caret-right"></i>
									Quản lý ngày phép
								</a>
							...
							?>
							<li class="active">
								<a href="<?php echo base_url() ?>quanlytaisan">
									<i class="menu-icon fa fa-caret-right"></i>
									Quản lý tài sản
								</a>
					...
					<li class="">
						...
						<ul class="submenu">
							...
							<li class="">
								<a href="<?php echo base_url() ?>quanly/taisan">
									<i class="menu-icon fa fa-caret-right"></i>
									Tai san
								</a>
									<i class="menu-icon fa fa-caret-right"></i>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<?php
								if ($noidung=='dsnv')
									$this->load->view('view_dsnv');
								if ($noidung=='taisan')
									$this->load->view('view_taisan');
								?>
							</div><!-- /.col -->
						</div><!-- /.row -->
					</div><!-- /.page-content -->
