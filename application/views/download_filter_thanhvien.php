...
<body>
	...
	<table>
		<tr>
            ...
            <td>Đã nhận thẻ</td>
            <td><input type="checkbox" name='danhanthe' value="1" 
                <?php 
                echo isset($danhanthe) && $danhanthe=='1'?'checked':'';
                ?> ></td>
	...
	<table id="example" class="table table-bordered" style="width:100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $value->noidkhk ?></td>
                <td><?php echo $value->cmnd ?></td>
                <td><?php echo $value->ngaycap ?></td>
                <td><?php echo $value->noicap ?></td>
                <td><?php echo  (strlen($value->sodtcanhan)>5)?$value->sodtcanhan:'' ?></td>
                <td><?php echo $value->sodtnguoithan ?></td>
                <td><?php if ($value->danhanthe=='1') echo "x"; ?></td>
                <td><?php if ($value->danhanthe=='1') 
                    echo $value->ngaynhanthe; else echo '&nbsp;'?></td>
                <td>&nbsp;&nbsp;</td>
            </tr>
            <?php
        	}
