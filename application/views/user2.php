...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>jqGrid - Quản trị website</title>
		...
		<link rel="stylesheet" href="<?php echo base_url();?>assets/admin/assets/css/jquery-ui.min.css" />
		<link rel="stylesheet" href="<?php echo base_url();?>assets/admin/assets/css/bootstrap-datepicker3.min.css" />
		<link rel="stylesheet" href="<?php echo base_url();?>assets/admin/assets/css/ui.jqgrid.min.css" />
					...
					<ul class="nav ace-nav">
									...
									<ul class="dropdown-menu dropdown-navbar">
										<li>
											<a href="#" class="clearfix">
												<img src="<?php echo base_url();?>assets/admin/assets/images/avatars/avatar.png" class="msg-photo" alt="Alex's Avatar" />
												<span class="msg-body">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="<?php echo base_url();?>assets/admin/assets/images/avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="<?php echo base_url();?>assets/admin/assets/images/avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="<?php echo base_url();?>assets/admin/assets/images/avatars/avatar2.png" class="msg-photo" alt="Kate's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="<?php echo base_url();?>assets/admin/assets/images/avatars/avatar5.png" class="msg-photo" alt="Fred's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="<?php echo base_url();?>assets/admin/assets/images/avatars/user.jpg" alt="Jason's Photo" />
...
<![endif]-->
		...
		<script src="<?php echo base_url();?>assets/admin/assets/js/jquery.jqGrid.min.js"></script>
		<script src="<?php echo base_url();?>assets/admin/assets/js/grid.locale-en.js"></script>
			...
			jQuery(function($) {
				...
				*/
				...
				jQuery(grid_selector).jqGrid({
					...
					editurl: "admin/dummy",//nothing is saved
